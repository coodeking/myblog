...
def build():
    ...
    # Mathematical Stages calculation (Total 34 weeks from May 1 to end of Dec)
    math_stages = [
        (4, "【高数基础】三十讲课后题+1000题基础", "张宇基础三十讲课后题+1000题基础做完。\n⚠️不听张宇课！基础差不要硬啃，遇到不懂直接去B站搜“1000题讲解”(千羽、考研数学777、没咋了等)。"),
        (3, "【线代基础】三十讲课后题+1000题基础", "张宇三十讲线代课后题+1000题基础做完。\n⚠️不准当「耐听王」！多想多算多做，一定要亲自落实到笔头上！"),
        # Note: Math II does not have Probability
        (3, "【澄箫宇大观】第一遍", "b站“澄箫宇”大观系列首刷，大概7个视频，两天看一个。\n⚠️核心绝杀：每讲一个题之前必须【暂停自己先做一遍】，做不出来再继续听小宇讲！"),
        (3, "【660题速刷】一阶速刷", "660一阶题速刷。\n⚠️速刷意思是把会做的做了，但凡2分钟没思路的直接跳过，然后对答案订正。别死磕，重塑信心最重要！"),
        (5, "【第一轮真题】真题一本通（于文涛）", "整个考研期最重要的习题册没有之一！\n✅ 搞个单独错题本，按章节分类整理，每个题务必弄懂！\n✅ 以计算题为重点复习，所有习题册只做这里的证明题！"),
        (2, "【澄箫宇大观】二刷", "带着真题的磨砺，二刷澄箫宇大观。这一次重点串联知识点网络，寻找顿悟的时刻。"),
        (3, "【二轮真题】数二真题", "每天一套数二（09-26年）。\n✅ 借套卷把真题错题本浓缩一下，整理对应的题型。咱们考数二专硕，不和数一硬碰硬，稳住就能赢！"),
        (2, "【全真模拟】李林6+4", "每天一套李林6+4（10套）。练习真实考场分配节奏。"),
        (4, "【武忠祥选填课+错题本】", "啃两本错题：真题错题本、模拟卷错题本。\n✅ 配合武忠祥选填技巧课，对应错题知识点看网课视频查漏补缺。"),
        (5, "【考前冲刺】近3年真题再刷", "最后阶段主要是看错题，不要光看！\n✅ 整理错题与知识点。\n✅ 做近3年真题熟悉考试风格（和模拟卷出入大，最相似的就是近3年卷子）。")
    ]
    ...
    # Adjust math tasks dynamically if weeks count exceeds 34
    while len(math_tasks) < 34:
        math_tasks.append(math_tasks[-1])
    math_tasks = math_tasks[:34]

    # English Stages
    eng_stages = [
        (8, "【暑假前】疯狂背单词", "唯一的任务：疯狂背考研核心词（约3000个）。\n⚠️强推《不背单词》APP，暑假前最好刷三遍！\n🚫考研英语少听课或者不听课，每天读阅读和背单词，不精翻文章，不买手译本！"),
        (16, "【暑假开始】英二真题+Monkey作文课", "✅ 两天一套英二真题（不写作文）。\n✅ 用《真题伴侣》APP标生词，反复背真题里的意思（期间原单词APP不能断！）。\n✅ 听Monkey考研作文模板课，背模板并积累主题词！"),
        (10, "【冲刺时间】二刷真题+练熟模板", "✅ 重点二刷错题。\n✅ 把作文模板练熟练透。\n⚠️ 持续背单词，绝对不能断！")
    ]
    eng_tasks = []
    ...
    while len(eng_tasks) < 34:
        eng_tasks.append(eng_tasks[-1])
    eng_tasks = eng_tasks[:34]

    # Politics Stages
    pol_stages = [
        (22, None, None), # May to early October is roughly 22 weeks
        (8, "【十月初起步】腿姐手册+苍盾刷题+一页纸", "⚠️ 远离徐涛冗长课，远离肖1000题！\n✅ 腿姐冲刺背诵手册（熟读）。\n✅《苍盾小程序》每天刷一套(30选择题)。\n✅ 熟读澄箫宇“政治一页纸”。"),
        (4, "【冲刺保命】死背肖四+B站抄材料", "✅ 等肖四出来后直接背大题（背不住没关系，对成绩影响不大）。\n🔥 最后几天务必看B站“考研政治抄材料”，上了考场基本只能抄材料，学会绝杀！")
    ]
    pol_tasks = []
    ...
    data = {"student": "愿", "weeks": weeks}
    
    with open("D:/myblog/source/kaoyan/yuan.json", "w", encoding="utf-8") as f:
...
<body>
    <div class="container">
        <header>
            <h1>愿 2027考研全程深度定制规划</h1>
            <div class="meta">
                <span>🎯 西安理工大学·集成电路·专硕</span>
                <span>📅 周期：2026.05.01 - 2026.12 考前 (共34周压缩冲刺)</span>
            </div>
            <div class="meta" style="margin-top: 8px;">
                <span>📚 必考：数学二 / 英语二 / 政治 / 专业课</span>
            </div>
        </header>
        ...
        <div class="overview">
            ...
            <p class="strategy">
                ...
                <span style="color: #ffb86c;">⚠️ 时间排布：抛开专业课，其余公共课分为数学 60%、英语 30%、政治 10%（只算不含专业课的占比大盘）。千万不要忘记在日历中为专业课留足时间（专业课学习时间默认比数学少一点，但必须保证其固定席位，自行安排）！</span><br><br>
                <span style="color: #60a5fa;">💡 专属强心剂：去年数一虽然遭遇挫折，但今年我们转战专硕数学二！卸下概率论和数一繁杂高数的包袱，稳扎稳打以计算为王，重塑信心，逆风翻盘！</span>
            </p>
...
'''
    ...
    with open("D:/myblog/source/kaoyan/yuan.html", "w", encoding="utf-8") as f:
