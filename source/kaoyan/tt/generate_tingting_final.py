...
def build():
    ...
    # Mathematical Stages calculation (Total 43)
    math_stages = [
    ...
    pol_stages = [
        (31, None, None), 
        (9, "【十月初起步】腿姐手册+苍盾刷题+一页纸", "⚠️ 远离徐涛冗长课，远离肖1000题！\n✅ 腿姐冲刺背诵手册（熟读）。\n✅《苍盾小程序》每天刷一套(30选择题)。\n✅ 熟读澄箫宇“政治一页纸”。"),
    ...
    with open("D:/myblog/source/kaoyan/tt/tingting_v4.json", "w", encoding="utf-8") as f:
    ...
    <div class="container">
        <header>
            ...
            <div class="meta">
                ...
                <span>📅 周期：2026.02.23 - 2026.12 考前 (共43周)</span>
            </div>
